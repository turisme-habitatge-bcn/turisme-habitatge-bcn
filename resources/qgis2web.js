...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 21, minZoom: 13
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([233460.674506, 5063115.595447, 249647.667628, 5079281.176266], map.getSize());
...
// Crear una función para mostrar el modal con el texto del abstract
function showInfo() {
    // Suponiendo que el "abstract" es el contenido que deseas mostrar
    var abstractText = "Versió 01. Les dades són de juliol-agost del 2024. No hem tingut en compte el CREAT: Cens de Reserva d'Establiments d'Allotjament Turístic, ni creuers turístic.";
    
    // Obtener el elemento de texto del modal y asignarle el contenido del abstract
    document.getElementById('info-modal-text').innerText = abstractText;
    
    // Mostrar el modal
    document.getElementById('info-modal').style.display = "block";
}

// Añadir un listener para el clic del icono de información
